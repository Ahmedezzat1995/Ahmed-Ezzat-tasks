            ...
            <div class="col-lg-6 col-md-12">
                <div class="product-details-img">
                    ...
                    <img class="zoompro" src="<?= $product['image'] ?>"
                        data-zoom-image="<?= $product['image'] ?>" alt="zoom" />
            ...
            <div class="col-lg-6 col-md-12">
                <div class="product-details-content">
                    ...
                    <div class="pro-dec-categories">
                        <ul>
                            <li><a
                                    href="shop.php?category=<?= $product['catogery_id']?>"><?= $product['catogery_name_en'] ?>,</a>
                            </li>
                            <li><a
                                    href="shop.php?subcategory=<?= $product['sub_catogrie_id'] ?>"><?= $product['sub_catogrery_name_en'] ?>,</a>
                            </li>
