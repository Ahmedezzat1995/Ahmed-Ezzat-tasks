...
use App\Database\Models\Catogery;
use App\Database\Models\sub_catogry;

$catogry_obj= new Catogery ;
$catogries = $catogry_obj->read()->fetch_all(MYSQLI_ASSOC);



$sub_catogry_obj= new sub_catogry ;
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li class="mega-menu-position top-hover"><a href="shop.php">shop</a>
                                        <ul class="mega-menu">
                                        <?php 
                                           foreach($catogries As $key =>$catogery)
                                           { 
                                                                
                                            $subcategories = $sub_catogry_obj->read($catogery['Id'])->fetch_all(MYSQLI_ASSOC);
                                            ?>
                                            <li>
                                                <ul>
                                                    <li > <a class=" font-weight-bold" href="shop.php?category=<?= $catogery['Id'] ?>"> <?= $catogery['name_en'] ?> </a></li>
                                                    <?php 
                                                    foreach($subcategories AS $sub_catogry){ ?>
                                                        <li><a href="shop.php?subcategory=<?= $sub_catogry['id'] ?>"><?= $sub_catogry['name_en'] ?></a></li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                                           <?php } ?>
