        ...
        if (is_numeric($_GET['brand']))
         {
            ...
            $products=$product_obj->read_products_by_brand($_GET['brand']);
            ...
            $products=$product_obj->read_products_by_brand($_GET['brand'])->fetch_all(MYSQLI_ASSOC);
        ...
        if (is_numeric($_GET['category']))
         {
            ...
            $products=$product_obj->read_products_by_category($_GET['category']);
            ...
            {
            $products=$product_obj->read_products_by_category($_GET['category'])->fetch_all(MYSQLI_ASSOC);
        ...
        if (is_numeric($_GET['subcategory']))
         {
            ...
            $products=$product_obj->read_products_by_subcategory($_GET['subcategory']);
            ...
            {
            $products=$product_obj->read_products_by_subcategory($_GET['subcategory'])->fetch_all(MYSQLI_ASSOC);
...
{   
    $products = $product_obj->read()->fetch_all(MYSQLI_ASSOC);
}
?>
                                        ...
                                        <div class="product-wrapper">
                                            <div class="product-img">
                                                <a href="product-details.php?product=<?= $product['id']?>">
                                                    <img alt="" src="<?php echo $product['image'] ?>">
                                                </a>
                                            ...
                                            <div class="product-content text-left">
                                                ...
                                                <div class="product-price-wrapper">
                                                    <span><?php echo "{$product['price']}  EG"; ?> </span>
                                                    <!-- <span class="product-price-old"><?php //echo $product['price'] ; 
                                                                                            ?></span> -->
                                                </div>
                                            </div>
