...
$products_new_products = $product_obj->read_new_products()->fetch_all(MYSQLI_ASSOC);

$product_most_orderd = $product_obj->read_most_order()->fetch_all(MYSQLI_ASSOC);
?>
<!-- Slider Start -->
                ...
                <div class="col-3">
                    <div class="product-img">
                        <a href="shop.php?brand=<?= $brand['id'] ?>">
                            <img alt="<?= $brand['name_en'] ?>" src="<?= $brand['image'] ?>">
                        </a>
                    </div>
                </div>
            <?php } ?>
...
<div class="section-title-wrap text-center">
    <h3 class="section-title my-3" >New products</h3>
</div>
<div class="product-area gray-bg pt-90 pb-65">
    <div class="container">
        <div class="row">
            <?php foreach ($products_new_products as $index => $product) { ?>
                <div class="col-3">
                    <div class="product-img">
                        <a href="product-details.php?product=<?= $product['id'] ?>">
                            <img alt="<?= $product['name_en'] ?>" src="<?= $product['image'] ?>">
                        </a>
...
<!-- most order Start -->
<div class="section-title-wrap text-center">
    <h3 class="section-title my-3"> Most Orderd</h3>
</div>
<div class="product-area gray-bg pt-90 pb-65">
    <div class="container">
        <div class="row">
            <?php foreach ($product_most_orderd as $index => $product) { ?>
                <div class="col-3">
                    <div class="product-img">
                        <a href="product-details.php?product=<?= $product['id'] ?>">
                            <img alt="<?= $product['name_en'] ?>" src="<?= $product['image'] ?>">
